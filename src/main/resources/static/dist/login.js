...
(() => {
  ...
  import_notiflix.default.Confirm.init({
  ...
  var [examRating, examRound, examType] = [document.getElementById("examRating"), document.getElementById("examRound"), document.getElementById("examType")];
  VirtualSelect.init({
    ele: "#examRating",
    maxWidth: "100%",
    options: [
  ...
  document.getElementById("examStart").onclick = (ev) => {
    import_notiflix.default.Confirm.show(
      "\uC2E4\uD589 \uD655\uC778",
      "\uC2DC\uD5D8\uC744 \uC2DC\uC791\uD558\uACA0\uC2B5\uB2C8\uAE4C?",
      "\uC608",
      "\uC544\uB2C8\uC624",
